...
class BinaryWrapper:
    ...
    def set_config(self, *, tag: str, interesting_region: bool, enable_cpu_backup: bool, num_chunks: int = 1):
        ...
        self.cdll.tms_set_num_chunks(num_chunks)
...
def _setup_function_signatures(cdll):
    ...
    cdll.tms_set_num_chunks.argtypes = [ctypes.c_size_t]
    cdll.tms_get_num_chunks.restype = ctypes.c_size_t
