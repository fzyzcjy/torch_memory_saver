...
class _TorchMemorySaverImpl:
    ...
    def _with_region_config(self, tag: str, enable_cpu_backup: bool):
        ...
        original_tag = cdll.tms_get_interesting_region()  # save whether we were already in a region
        original_enable_cpu_backup = cdll.tms_get_enable_cpu_backup()
        ...
        try:
            ...
            self._binary_wrapper.set_config(
                tag=_TAG_DEFAULT,
                interesting_region=original_tag,
